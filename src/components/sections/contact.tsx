      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto mt-12 max-w-xl space-y-8">
            <div className="rounded-lg border border-accent/50 bg-accent/10 p-4 text-center">
                ...
                ¿Restaurante, peluquería o tienda? Aprovecha nuestra <Link href="/#pricing" className="font-bold text-accent hover:underline">oferta de agosto</Link>: tu web básica por solo 299€.
                </p>
            </div>
            <ContactForm />
        </div>
